...
public class Question2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(rb1.isChecked()) { MainActivity.hm.put("q2",1); }
                else if(rb2.isChecked()) { MainActivity.hm.put("q2",2); }
                else if(rb3.isChecked()) { MainActivity.hm.put("q2",3); }
                else if(rb4.isChecked()) { MainActivity.hm.put("q2",4); }
    ...
    protected void onStart() {
        super.onStart();
        if(MainActivity.hm.get("q2")!=null) {
            int choice = MainActivity.hm.get("q2");
